  ...
  const { mutate: patchUser } = useMutation(
    (newUserData: User) => patchUserOnServer(newUserData, user),
    {
      ...
      onMutate: async (newData: User | null) => {
        ...
        const previousUserData: User = queryClient.cancelQueries(
          queryKeys.user,
        );
        ...
        // return context object with snap shotted value
      ...
      onSettled: () => {
        // invalidate user query to make sue we're in sync with server data
